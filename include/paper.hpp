...
class Paper: public vector<cv::Point2f> {
 public:
  ...
  void calculateExtrinsics(cv::Size paperSizeMeters, CameraProjectorSystem& cameraProjector, bool setYPerperdicular, bool screenExtrinsics) throw(cv::Exception);
