...
namespace argosServer{
  ...
  public:
     ...
     */
    void load(const string& cameraConfig = "calibrationCamera.yml",
              const string& projectorConfig  = "calibrationProjector.yml",
              const string& extrinsicsConfig = "CameraProjectorExtrinsics.yml");
    /**
